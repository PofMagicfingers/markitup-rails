...
Gem::Specification.new do |s|
  s.name        = "podcloud-markitup-rails"
  ...
  s.authors     = ["Pof Magicfingers", "Uri Gorelik", "Phil Cohen"]
  s.email       = ["pof@podcloud.fr", "uri@ndstorefront.com", "github@phlippers.net"]
  s.homepage    = "https://github.com/pofmagicfingers/podcloud-markitup-rails"
